        ...
        <div class="max-w-5xl mx-auto">
            <div class="flex justify-between items-center">
                ...
                <div class="flex gap-2 items-center z-20 relative">
                    ...
                    <a href="index.html"><img src="{{ asset('public/frontend') }}/assets/images/logo.png" alt="" class="h-7"></a>
                </div>
                ...
                <div id="header-nav" class="max-md:hidden max-md:bg-white max-md:p-5 max-md:fixed max-md:top-0 max-md:shadow-md max-md:left-0 max-md:pt-14 max-md:w-full max-md:z-10">
                    ...
                    @auth
                        ...
                        <a href="{{ url('/home') }}" class="lg:py-1.5 py-2.5 px-3 duration-500 hover:text-black" >Profile</a>

                    @else
                        <a href="{{ route('login') }}" class="lg:py-1.5 py-2.5 px-3 duration-500 hover:text-black">Log in</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="lg:py-1.5 py-2.5 px-3 duration-500 hover:text-black">Register</a>
                        @endif
                    @endauth
                  @endif
                  ...
                  @auth
                         ...
                         <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button class="lg:py-1.5 py-2.5 px-3 duration-500 hover:text-black" type="submit" href="{{ route('logout') }}">Logout</button>
                        </form>
                    @endauth
            ...
            <div class="max-w-5xl mx-auto space-y-32 max-md:p-8">
                ...
                <section id="home">
                    ...
                    <div class="flex flex-col justify-center mt-6 text-center gap-6">
                        <div>
                            <img src="{{ asset('public/frontend') }}/assets/images/logo-icon-2.png" alt="" class="max-md:w-24  mx-auto">
                        </div>
                    ...
                    <div class="flex items-center justify-center relative md:mt-32 mt-20" >
                        ...
                        <div class="lg:rounded-xl rounded-md shadow-xl z-10 scale-125 overflow-hidden relative w-1/2">
                            <img src="{{ asset('public/frontend') }}/assets/images/demos/home.png" alt="" class="">
                        </div>
                        ...
                        <div class="w-1/2 absolute left-0 delay-500 uk-animation-slide-right-medium">
                            <div class="lg:rounded-xl rounded-md shadow-md overflow-hidden -skew-x-6">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/messages.png" alt="">
                            </div>
                        </div>
                        <div class="w-1/2 absolute right-0 duration-50 uk-animation-slide-left-medium">
                            <div class="lg:rounded-xl rounded-md shadow-md overflow-hidden skew-x-6">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/timeline.png" alt="">
                            </div>
                        </div>
            ...
            <div class="max-w-5xl mx-auto max-lg:p-8">
                ...
                <div class="grid sm:grid-cols-3 gap-6 lg:mt-20 mt-10 text-center font-normal capitalize"   uk-scrollspy="target: > a ; cls: uk-animation-slide-bottom-small ; delay: 160">
                    ...
                    <a href="feed.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/home.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="messages.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/messages.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="video.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/videos.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="video-watch.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/videos-watch.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="event.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/events.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="event-2.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/event-2.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="pages.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/pages.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="groups.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/groups.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="groups-2.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/groups-2.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="market.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/products.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="product-view-2.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/product-view-2.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="blog.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/blogs.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                     ...
                     <a href="blog-2.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/blogs-2.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="blog-read.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/blog-read.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="games.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/games.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="funding.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/funding.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="timeline.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/timeline.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="timeline-page.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/timeline-page.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="timeline-group.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/timeline-group.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="timeline-event.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/timeline-event.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="timeline-funding.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/timeline-funds.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="setting.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/settings.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="upgrade.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/upgrade.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="components.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/components.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="form-login.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/form-login.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <a href="form-register.html" target="_blank">
                        <div class="group"> 
                            <div class="md:rounded-lg rounded-md shadow-md overflow-hidden duration-300 group-hover:-translate-y-1 group-hover:scale-[1.01] group-hover:shadow-lg">
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/form-register.png" alt="" class="w-full h-full object-cover inset-0">
                            </div>
                    ...
                    <div class="md:w-3/5 w-full">
                        ...
                        <a href="#">
                            <div class=" relative">
                                ...
                                <img src="{{ asset('public/frontend') }}/assets/images/demos/code-prev.jpg" alt="" class="w-full h-full object-cover inset-0 md:rounded-b-xl rounded-b-md shadow-lg">
    
                                <img src="{{ asset('public/frontend') }}/assets/images/brand-uikit.svg" alt="" class="w-12 h-12 rounded-full absolute  top-8 -right-6 bg-white shadow-md p-1.5">
                                <img src="{{ asset('public/frontend') }}/assets/images/brand-tailwind.svg" alt="" class="w-12 h-12 rounded-full absolute  -bottom-5 right-6 bg-white shadow-md p-1.5">
                      ...
                      <ul class="-ml-2 uk-slider-items w-[calc(100%+0.875rem)]"> 
                            ...
                            <a href="https://themeforest.net/item/instello-ultimate-photo-sharing-html-template/29882650" target="_blank">
                                <div class="flex flex-col">
                                    <div class="relative w-full h-full">
                                        <img src="{{ asset('public/frontend') }}/assets/images/demos/prev-installo.png" alt="" class="w-full h-full object-cover inset-0 md:rounded-lg rounded-md shadow">
                                    </div> 
                        ...
                        <li class="md:w-1/2 w-full pr-3.5">
                            <a href="https://themeforest.net/item/flex-modern-multipurpose-tailwind-template/34769270" target="_blank">
                                <div class="flex flex-col">
                                    <div class="relative w-full h-full">
                                        <img src="{{ asset('public/frontend') }}/assets/images/demos/prev-flex.png" alt="" class="w-full h-full object-cover inset-0 md:rounded-lg rounded-md shadow">
                                    </div> 
                                    <div class="relative mt-4"> 
                        ...
                        <li class="md:w-1/2 w-full pr-3.5">
                            <a href="https://themeforest.net/item/courseplus-modern-learning-management-application/23651460" target="_blank">
                                <div class="flex flex-col">
                                    <div class="relative w-full h-full">
                                        <img src="{{ asset('public/frontend') }}/assets/images/demos/prev-courseplus.png" alt="" class="w-full h-full object-cover inset-0 md:rounded-lg rounded-md shadow">
                                    </div> 
                                    <div class="relative mt-4"> 
