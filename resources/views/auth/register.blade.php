  ...
  <div class="sm:flex">
    ...
    <div class="relative lg:w-[580px] md:w-96 w-full p-10 min-h-screen bg-white shadow-xl flex items-center pt-10 dark:bg-slate-900 z-10">
      ...
      <div class="w-full lg:max-w-sm mx-auto space-y-10" uk-scrollspy="target: > *; cls: uk-animation-scale-up; delay: 100 ;repeat: true">
        ...
        <!-- logo image-->
        <a href="#"> <img src="{{ asset('public/frontend') }}/assets/images/logo.png" class="w-28 absolute top-10 left-10 dark:hidden" alt=""></a>
        <a href="#"> <img src="{{ asset('public/frontend') }}/assets/images/logo-light.png" class="w-28 absolute top-10 left-10 hidden dark:!block" alt=""></a>

        <!-- logo icon optional -->
        <div class="hidden">
          <img class="w-12" src="{{ asset('public/frontend') }}/assets/images/logo-icon.png" alt="Socialite html template">
        </div>
        ...
        @csrf
          ...
          <div class="grid grid-cols-2 gap-4 gap-y-7">
            ...
            <div class="col-span-2">
                ...
                <div class="mt-2.5">
                    <input id="name" name="name" type="text"  autofocus="" placeholder="Enter Full name" required="" class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5"> 
                </div>
           ...
           {{-- <div>
            ...
            <div class="col-span-2">
                ...
                <div class="mt-2.5">
                    <input id="phone" name="phone" type="number" placeholder="Phone" required="" class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5"> 
                </div>
            ...
            <div>
              ...
              <div class="mt-2.5">
                  <input id="password" name="password" type="password" placeholder="***"  class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5" required autocomplete="new-password" >  
              </div>
            ...
            <div>
                ...
                <div class="mt-2.5">
                    <input id="password_confirmation" name="password_confirmation" type="password" placeholder="***"  class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5" required autocomplete="new-password" >  
                </div>
    ...
    <div class="flex-1 relative bg-primary max-md:hidden">
      ...
      <div class="relative w-full h-full" tabindex="-1" uk-slideshow="animation: slide; autoplay: true">
        ...
        <ul class="uk-slideshow-items w-full h-full"> 
            <li class="w-full">
                <img src="{{ asset('public/frontend') }}/assets/images/post/img-3.jpg"  alt="" class="w-full h-full object-cover uk-animation-kenburns uk-animation-reverse uk-transform-origin-center-left">
            ...
            <li class="w-full">
              <img src="{{ asset('public/frontend') }}/assets/images/post/img-2.jpg"  alt="" class="w-full h-full object-cover uk-animation-kenburns uk-animation-reverse uk-transform-origin-center-left">
              <div class="absolute bottom-0 w-full uk-tr ansition-slide-bottom-small z-10">
                  <div class="max-w-xl w-full mx-auto pb-32 px-5 z-30 relative"  uk-scrollspy="target: > *; cls: uk-animation-scale-up; delay: 100 ;repeat: true" > 
                      <img class="w-12" src="{{ asset('public/frontend') }}/assets/images/logo-icon.png" alt="Socialite html template">
